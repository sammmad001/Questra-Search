"""
Questra-Search 集中配置管理 - 从 .env 文件加载配置
"""
import os
...
# Questra-Search 上游 API (MiroThinker)
...
# JWT 认证
JWT_SECRET: str = _get("JWT_SECRET", "questra-search-secret-key-change-in-production-2026")
...
# SQLite 数据库
DATABASE_PATH: str = _get("DATABASE_PATH", "data/questra_search.db")
